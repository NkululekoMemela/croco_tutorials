     ...
     &                                      'record =', record
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (zeta(0,0,1), ncid, varid,
     &                                         record, r2dvar)
     ...
     &                                ,ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (ubar(0,0,1), ncid, varid,
     &                                         record, u2dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                ,ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (vbar(0,0,1), ncid, varid,
     &                                         record, v2dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                ,ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (u(0,0,1,tindx), ncid, varid,
     &                                         record, u3dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                ,ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (v(0,0,1,tindx), ncid, varid,
     &                                         record, v3dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                ,ininame(1:lstr)
      ...
      do itrc=1,NT
        ...
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (t(0,0,1,tindx,itrc), ncid, varid,
     &                                                record, r3dvar)
          if (ierr .ne. nf_noerr) then
