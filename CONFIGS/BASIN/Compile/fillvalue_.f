     ...
     &                       record,typevar2d,typefile)
      ...
      real work2d_tmp(0:Lm+1+padd_X,0:Mm+1+padd_E)
      logical mask(0:Lm+1+padd_X,0:Mm+1+padd_E)
      real mask2(0:Lm+1+padd_X,0:Mm+1+padd_E)
 ...
 100  continue
     ...
     &                       record,typevar3d,typefile)
      ...
      parameter (ntrc_diaeddy=0)
      parameter (ntrc_surf=0)
      real work3d_tmp(0:Lm+1+padd_X,0:Mm+1+padd_E,N)
      real work2d_tmp(0:Lm+1+padd_X,0:Mm+1+padd_E)
      integer*4 ierr, record, lstr, lvar, lenstr,
 ...
 100  continue
     ...
     &                       record,typevar3d,typefile)
      ...
      parameter (ntrc_diaeddy=0)
      parameter (ntrc_surf=0)
      real work3d_tmp(0:Lm+1+padd_X,0:Mm+1+padd_E,0:N)
      real work2d_tmp(0:Lm+1+padd_X,0:Mm+1+padd_E)
      integer*4 ierr, record, lstr, lvar, lenstr,
