...
!$AGRIF_END_DO_NOT_TREAT
     ...
     &      , itrc
      ...
      ierr=nf_fwrite(zeta(0,0,knew), ncidrst,
     &                                      rstZ, record, r2dvar)
      if (ierr .ne. nf_noerr) then
      ...
      ierr=nf_fwrite(ubar(0,0,knew), ncidrst,
     &                                     rstUb, record, u2dvar)
      if (ierr .ne. nf_noerr) then
      ...
      ierr=nf_fwrite(vbar(0,0,knew), ncidrst,
     &                                     rstVb, record, v2dvar)
      if (ierr .ne. nf_noerr) then
      ...
      ierr=nf_fwrite(u(0,0,1,nstp), ncidrst, rstU,
     &                                        record, u3dvar)
      if (ierr .ne. nf_noerr) then
      ...
      ierr=nf_fwrite(v(0,0,1,nstp), ncidrst, rstV,
     &                                        record, v3dvar)
      if (ierr .ne. nf_noerr) then
      ...
      do itrc=1,NT
        ierr=nf_fwrite(t(0,0,1,nstp,itrc), ncidrst,
