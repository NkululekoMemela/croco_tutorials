     ...
     &                                             'meter2 second-1')
      if (maxval(Zob).ne.0.D0) then
        ierr=nf_put_att_double(ncid,nf_global,'Zob',nf_ftype,1,
     &                                                      maxval(Zob))
     ...
     &                                                       'meter')
        ierr=nf_put_att_double(ncid,nf_global,'Cdb_max',nf_ftype,1,
     &                                                       Cdb_max)
        ierr=nf_put_att_double(ncid,nf_global,'Cdb_min',nf_ftype,1,
     &                                                       Cdb_min)
     ...
     &                                            'kilogram meter-3')
      ierr=nf_put_att_double(ncid,nf_global,'T0',  nf_ftype, 1, T0)
     ...
     &                                            'Celsius')
      ierr=nf_put_att_double(ncid,nf_global,'S0',  nf_ftype, 1, S0)
     ...
     &                                            'PSU')
      ierr=nf_put_att_double(ncid,nf_global,'R0',  nf_ftype, 1, R0)
     ...
     &                                            'kilogram meter-3')
      ierr=nf_put_att_double(ncid,nf_global,'Tcoef',nf_ftype, 1,Tcoef)
      ierr=nf_put_att_text (ncid,nf_global,'Tcoef_expl',29,
     &                               'thermal expansion coefficient')
      ierr=nf_put_att_text (ncid,nf_global,'Tcoef_units',10,
     &                                                 'kg.m-3.C-1')
      ierr=nf_put_att_double(ncid,nf_global,'Scoef',nf_ftype, 1,Scoef)
